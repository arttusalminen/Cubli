...
public class calculator3d {
    ...
    static double CalcPositionX(double[] ViewFrom, double[] ViewTo, double x, double y, double z){
        SetStuff(ViewFrom, ViewTo, x, y, z);
        return DrawX;
    }

    static double CalcPositionY(double[] ViewFrom, double[] ViewTo, double x, double y, double z){
        SetStuff(ViewFrom, ViewTo, x, y, z);
        return DrawY;
    }
